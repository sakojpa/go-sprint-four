...
func RunningSpentCalories(action int, weight, duration float64) float64 {
    spentCalories := (runningCaloriesMeanSpeedMultiplier * meanSpeed(action, duration) *
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
    ...
    spentCalories := (walkingCaloriesWeightMultiplier*weight + (math.Pow(meanSpeed(action, duration)*kmhInMsec,
        2)/(height/cmInM))*walkingSpeedHeightMultiplier*weight) * duration * minInH
...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
    spentCalories := (swimmingCaloriesMeanSpeedShift + swimmingMeanSpeed(lengthPool, countPool,
        duration)) * swimmingCaloriesWeightMultiplier * weight * duration
